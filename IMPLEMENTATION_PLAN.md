...
- Status: Option A was approved by the user and incorporated into `SPECIFICATION.md`; red-first regression coverage, minimal implementation, focused validation, and integrated local validation are complete on the claimed branch. Review submission remains.
